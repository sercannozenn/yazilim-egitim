...
<head>
    ...
    <!-- Icofont CSS -->
    <link rel="stylesheet" href={{ asset("assets/front/css/vendor/icofont.min.css") }} />
    ...
    <!-- AOS CSS -->
    <link rel="stylesheet" href={{ asset("assets/front/css/plugins/aos.css") }}>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8">
                        ...
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/front/images/logo/logo.png" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
...
<!-- jQuery JS -->
<script src={{ asset("assets/front/js/vendor/jquery-3.5.1.min.js") }}></script>
...
<!-- Masonry JS -->
<script src={{ asset("assets/front/js/plugins/masonry.min.js") }}></script>

<!-- ImagesLoaded JS -->
<script src={{ asset("assets/front/js/plugins/images-loaded.min.js") }}></script>

<!-- Swiper Bundle JS -->
<script src={{ asset("assets/front/js/plugins/swiper-bundle.min.js") }}></script>

<!-- AOS JS -->
<script src={{ asset("assets/front/js/plugins/aos.js") }}></script>

<!-- Ajax JS -->
<script src={{ asset("assets/front/js/plugins/ajax.mail.js") }}></script>
